...
def planning(goal):
    ...
    feedback = RT_assignment_2.msg.PlanningFeedback()
    result = RT_assignment_2.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal', RT_assignment_2.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
